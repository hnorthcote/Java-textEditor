    ...
    public class TextEditor extends Frame {
        ...
        Frame fm;
            ...
            TextEditor()
            {
                ...
                MenuItem boldmenu, plainmenu, italicmenu;
                boldmenu=new MenuItem("Bold");
                plainmenu=new MenuItem("Regular");
                italicmenu=new MenuItem("Italic");
        ...
        class WW implements ActionListener
            {
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    if(se.equals("undo")) txt.undo();
                    if(se.equals("Redo")) txt.redo();
